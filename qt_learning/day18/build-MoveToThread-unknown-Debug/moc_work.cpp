...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Work_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Work_t qt_meta_stringdata_Work = {
    {
        QT_MOC_LITERAL(0, 4),  // "Work"
        QT_MOC_LITERAL(5, 6),  // "doWork"
        QT_MOC_LITERAL(12, 0)   // ""
    },
    "Work",
    "doWork",
...
Q_CONSTINIT static const uint qt_meta_data_Work[] = {
...
Q_CONSTINIT const QMetaObject Work::staticMetaObject = { {
    ...
    qt_meta_stringdata_Work.offsetsAndSizes,
    qt_meta_data_Work,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Work_t,
        // Q_OBJECT / Q_GADGET
